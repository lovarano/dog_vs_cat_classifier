...
def calculates_results_stats(results_dic):
    ...
    # this function 
    # Creates a dictionary for the finyl results of statistics
    results_stats_dic = dict()
    
    # Initialize the values in count
    ...
    # Looping through the results dictionary
    for key in results_dic:
        # Check if the model label matched
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1        
        # Checking if dog labe is a Dog and label matches - counts Correct Breed
    ...
    # Return the results in dictionary
